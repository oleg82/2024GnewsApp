...
struct ContentView: View {
    ...
    var body: some View {
        ...
        switch selection {
        case .worldNewsTag:
            GnewsListView(category: DefaultAPI.Category_topHeadlinesGet.world)
        case .nationNewsTag:
            GnewsListView(category: DefaultAPI.Category_topHeadlinesGet.nation)
        case .businessNewsTag:
            GnewsListView(category: DefaultAPI.Category_topHeadlinesGet.business)
        }
    }
}
