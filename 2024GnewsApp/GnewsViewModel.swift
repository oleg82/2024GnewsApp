...
//    private static let gnewsApikey = "72dd619cbd513c6ea0661387e389f7c2"
    ...
    func loadNext(category: DefaultAPI.Category_topHeadlinesGet) {
        ...
        Task {
            guard let result = try? await DefaultAPI.topHeadlinesGet(category: category, apikey: GnewsViewModel.gnewsApikey, max: GnewsViewModel.maxArticles, page: page) else {
